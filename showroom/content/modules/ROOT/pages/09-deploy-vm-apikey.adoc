...
* Scaffold a RHEL VM via Developer Hub onto OpenShift Virtualization
* Expose the VM through Connectivity Link with API key auth
* Reuse the same GitOps + AuthPolicy pattern outside the Neuralbank/NFL Wallet demos
