...
* Trace Neuralbank traffic through Gateway, HTTPRoute, OIDCPolicy, and RateLimitPolicy
* Obtain a Keycloak token and call the API successfully
* Contrast this OIDC path with the 3scale Product configuration from module 3
