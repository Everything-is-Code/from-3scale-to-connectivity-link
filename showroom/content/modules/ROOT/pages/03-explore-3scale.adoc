...
* Inspect Neuralbank (OIDC) and NFL Wallet (API Key) as 3scale Products
* Relate Products, Backends, MappingRules, and Application Plans to live traffic
* Capture the source configuration you will recreate with Connectivity Link
...
NOTE: This lab migrates routing, auth, and rate limits. 3scale *billing / monetization* and the full *Developer Portal CMS* are out of scope (see xref:01-migration-overview.adoc[What this workshop does not cover]).
