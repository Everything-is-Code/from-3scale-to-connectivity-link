...
Return to xref:10-summary.adoc[Summary] or revisit the strategy modules (xref:07-run-migration.adoc[Golden Path], xref:11-kuadrant-console.adoc[Kuadrant Console], xref:12-migration-toolkit.adoc[Migration Toolkit], xref:13-apishift-gateforge.adoc[APIShift]).
