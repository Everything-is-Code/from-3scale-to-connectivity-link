...
NOTE: The public https://everything-is-code.github.io/from-3scale-to-connectivity-link/[GitHub Pages] site is a *documentation preview*. Placeholders such as `apps.cluster.example.com` and `{cluster_domain}` are *not* live hosts. On a deployed showroom, those values are rewritten automatically to your cluster domain.
...
https://github.com/Everything-is-Code/from-3scale-to-connectivity-link#cluster-sizing
