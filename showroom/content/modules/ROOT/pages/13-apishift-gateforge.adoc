...
*APIShift* is an end-to-end migration console. It performs the *same* 3scale → Connectivity Link migration path as the xref:12-migration-toolkit.adoc[Migration Toolkit], and adds two capabilities on top:
...
* xref:07-run-migration.adoc[Run the Migration Template] — Backstage Software Template path
